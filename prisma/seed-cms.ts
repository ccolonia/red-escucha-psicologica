...
async function main() {
  ...
  const registrationFields = [
    {
      ...
      fieldKey: "title",
      fieldType: "select",
      options: JSON.stringify(["Lic.", "Dr.", "Dra.", "Ninguno"]),
      required: true,
      active: true,
    ...
    },
    {
      ...
      helperText: "Ingresá tu número con código de área sin el 0 y sin el 15",
      order: 3,
      section: "personal",
    },
    {
    ...
    },
    {
      ...
      fieldKey: "gender",
      fieldType: "select",
      options: JSON.stringify(["Femenino", "Masculino", "Otro"]),
      required: false,
      active: true,
      placeholder: "Seleccionar",
      helperText: null,
  ...
  for (const field of registrationFields) {
    await prisma.cmsRegistrationField.upsert({
      where: { id: field.id },
      update: field,
      create: field,
    });
  }
  console.log(`✅ ${registrationFields.length} registration fields seeded`);
