      ...
      >
          ...
          <div className="flex items-center justify-between h-20 md:h-22">
            ...
            <div className="hidden md:flex items-center gap-8">
              <button
                ...
                className="text-sm text-forest-700 hover:text-forest-900 transition-colors font-medium tracking-wide" style={{ fontFamily: "Montserrat, sans-serif" }}
              >
                Inicio
              </button>
              <button
        ...
        >
          <div className="bg-beige-100/95 backdrop-blur-xl border-t border-forest-900/10 px-4 py-4 space-y-1">
            <button
              onClick={() => scrollToSection("inicio")}
              className="w-full text-left px-4 py-3 text-forest-700 hover:text-forest-900 hover:bg-forest-900/5 rounded-lg transition-colors text-base min-h-[44px] flex items-center" style={{ fontFamily: "Montserrat, sans-serif" }}
            >
              Inicio
            </button>
            <button
