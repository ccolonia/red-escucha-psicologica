  ...
  return (
    <div className="min-h-screen flex flex-col bg-beige-100 overflow-x-hidden">
      ...
      <button
        ...
        className="fixed z-50 w-14 h-14 bg-sage-500 hover:bg-sage-600 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 relative"
        style={{ left: 'auto', bottom: 'max(9.5rem, calc(env(safe-area-inset-bottom, 1.5rem) + 8rem))', right: 'max(1.5rem, env(safe-area-inset-right, 1.5rem))' }}
      ...
      <button
        onClick={() => scrollToSection("contacto")}
        className="fixed z-50 w-14 h-14 bg-amber-500 hover:bg-amber-600 text-white rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 relative"
        style={{ left: 'auto', bottom: 'max(5.5rem, calc(env(safe-area-inset-bottom, 1.5rem) + 4rem))', right: 'max(1.5rem, env(safe-area-inset-right, 1.5rem))' }}
      ...
      <a
        ...
        style={{ left: 'auto', bottom: 'max(1.5rem, env(safe-area-inset-bottom, 1.5rem))', right: 'max(1.5rem, env(safe-area-inset-right, 1.5rem))' }}
      >
