      ...
      <div className="min-h-screen flex items-center justify-center bg-beige-100">
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-sm text-forest-300 font-light mb-6" style={{ fontFamily: "Montserrat, sans-serif" }}>
              Podés solicitar un nuevo enlace desde la página de inicio de sesión.
            </p>
            <Button
      ...
      <div className="min-h-screen flex items-center justify-center bg-beige-100">
        <div className="max-w-md w-full mx-4">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-forest-400 font-light mb-6" style={{ fontFamily: "Montserrat, sans-serif" }}>
              Tu contraseña fue actualizada exitosamente. Ya podés ingresar con tu nueva contraseña.
            </p>
            <Button
              onClick={() => router.push("/#login")}
              className="btn-sage text-forest-900 font-semibold px-8 h-11 rounded-full"
